        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          <div>
            <p className="text-sm leading-relaxed text-luxury-bg/65">
              Medicina estética de excelencia en Mazatlán. Tecnología médica de
              punta con resultados naturales y atención personalizada.
            </p>
          </div>
                  ...
                  <a
                    ...
                    aria-label={
                      link.label === "Instagram"
                        ? "Instagram — @clinica.laurasimental"
                        : link.label === "TikTok"
                          ? "TikTok — @dra.laurasimental"
                          : `${link.label} — Clínica Dra. Laura Simental`
                    }
