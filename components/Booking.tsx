...
import { AVAILABLE_TIMES, CLINIC, whatsappUrl } from "@/lib/data";

const WHATSAPP_MESSAGE =
  "Hola, me gustaría consultar disponibilidad para aparatología médica (Morpheus 8 / Alma Prime X) en Clínica Dra. Laura Simental.";
          ...
          {tab === "calendar" ? (
                  ...
                  {calendarDays.map((day, i) => {
                    ...
                    return (
                      <button
                        ...
                        className={`rounded-sm py-2 text-sm transition-all duration-300 ${
                          isPast
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {AVAILABLE_TIMES.map((time) => (
                      <button
                        ...
                        className={`rounded-sm px-3 py-2 text-sm transition-all duration-300 ${
                          selectedTime === time
                            ? "bg-luxury-dark text-luxury-bg"
            ...
            <div className="text-center">
              <p className="mb-6 text-luxury-text">
                Tratamientos avanzados como Morpheus 8 y Alma Prime X requieren
                validación personalizada con nuestra asistente clínica.
              </p>
              <a
