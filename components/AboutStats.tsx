      ...
      <div className="luxury-container">
        <div className="mx-auto max-w-3xl text-center">
          <div className="mb-6 flex justify-center">
            <Logo variant="navbar" showText asLink={false} />
          </div>
          <p className="section-label">Sobre nosotros</p>
          <h2 className="section-title">
            En la clínica creemos en resultados naturales y atención humana
          </h2>
          <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-luxury-text/85 sm:leading-loose">
            Combinamos aparatología médica certificada, protocolos personalizados
            y un espacio diseñado para tu tranquilidad. Cada tratamiento se
            planifica con precisión clínica para realzar tu belleza sin perder
            autenticidad.
          </p>
